...
// r_score
float r_score(Eigen::MatrixXd X, Eigen::MatrixXd X0, float lambda);
RcppExport SEXP _TSDFGS_r_score(SEXP XSEXP, SEXP X0SEXP, SEXP lambdaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type X(XSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(r_score(X, X0, lambda));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_TSDFGS_r_score", (DL_FUNC) &_TSDFGS_r_score, 3},
    {NULL, NULL, 0}
};
